...
storiesOf("DayListItem", module) 
  ...
  .add("Selected", () => <DayListItem name="Wednesday" spots={3} selected />)
  .add("Full", () => <DayListItem name="Friday" spots={0} />)
  // action() allows us to create a callback that appears in the actions panel when clicked
  .add("Clickable", () => (
    <DayListItem name="Tuesday" setDay={event => action("setDay")("Tuesday")} spots={4} />
  ));
